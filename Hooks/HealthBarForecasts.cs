...
public static class HealthBarForecasts
{
    ...
    {
        return new(For(context), color, HealthBarForecastDirection.FromRight, overlaySelfModulate);
    }
    ...
    public static HealthBarForecastLaneBuilder FromLeft(
        ...
        Color? overlaySelfModulate)
    {
        return new(For(context), color, HealthBarForecastDirection.FromLeft, overlaySelfModulate);
    }
...
public sealed class HealthBarForecastSequenceBuilder(HealthBarForecastContext context)
{
    ...
    {
        return new(this, color, HealthBarForecastDirection.FromRight, overlaySelfModulate);
    }
    ...
    {
        return new(this, color, HealthBarForecastDirection.FromLeft, overlaySelfModulate);
    }
